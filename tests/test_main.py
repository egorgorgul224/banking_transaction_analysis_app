...
@patch("main.get_top_amount_transactions")
@patch("main.get_cards_info")
@patch("main.get_cards_spent_cashback")
@patch("main.get_cards_number")
@patch("main.get_period_transactions")
@patch("main.get_date_period")
@patch("main.get_excel_file")
@patch("main.get_greeting")
...
def test_main(
    ...
    mock_get_cards_number,
    mock_get_cards_spent_cashback,
    mock_get_cards_info,
    mock_get_top_amount_transactions,
